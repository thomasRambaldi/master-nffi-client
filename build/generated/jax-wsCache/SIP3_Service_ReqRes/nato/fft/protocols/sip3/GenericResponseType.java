 ...
 *         &lt;element name="Message" type="{urn:nato:fft:protocols:sip3}DataType"/>
 *       &lt;/sequence>
...
public class GenericResponseType {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "Message", namespace = "urn:nato:fft:protocols:sip3", type = JAXBElement.class),
        @XmlElementRef(name = "allAvailableDataTransferred", namespace = "urn:nato:fft:protocols:sip3", type = JAXBElement.class)
    })
    @XmlMixed
